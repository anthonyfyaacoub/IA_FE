    ...
    <div class="container">
      ...
      <b-modal ref="addRecipeModal" id="recipe-modal" title="Create a new recipe" hide-backdrop hide-footer>
        <b-form @submit="onSubmit" class="w-100">
          ...
          <b-form-group id="form-ingredients-group" label="Recipe Ingredients:" label-for="form-ingredients-input">
            <b-form-input id="form-ingredients-input" type="text" v-model="createRecipeForm.ingredients"
              placeholder="Recipe Ingredients" required>
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-steps-group" label="Recipe Steps:" label-for="form-steps-input">
            <b-form-input id="form-steps-input" type="text" v-model="createRecipeForm.steps" placeholder="Recipe Steps"
              required>
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-rating-group" label="Recipe Rating:" label-for="form-rating-input">
            <b-form-input id="form-rating-input" type="number" v-model.number="createRecipeForm.rating"
              placeholder="Recipe Rating" required>
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-favorite-group" label="Recipe Favorite:" label-for="form-favorite-input">
            <b-form-checkbox id="form-favorite-input" type="checkbox" v-model="createRecipeForm.favorite" required>
            </b-form-checkbox>
          </b-form-group>
      ...
      <b-modal ref="editRecipeModal" id="edit-recipe-modal" title="Edit the recipe" hide-backdrop hide-footer>
        <b-form @submit="onSubmitUpdate" class="w-100">
          ...
          <b-form-group id="form-edit-ingredients-group" label="Recipe Ingredients:"
          ...
          <b-form-group id="form-edit-steps-group" label="Recipe Steps:" label-for="form-edit-steps-input">
            <b-form-input id="form-edit-steps-input" type="text" v-model="editRecipeForm.steps"
              placeholder="Recipe Steps" required>
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-edit-rating-group" label="Recipe Rating:" label-for="form-edit-rating-input">
            <b-form-input id="form-edit-rating-input" type="number" v-model.number="editRecipeForm.rating"
              placeholder="Recipe Rating" required>
            </b-form-input>
          </b-form-group>
          <b-form-group id="form-edit-favorite-group" label="Recipe Favorite:" label-for="form-edit-favorite-input">
            <b-form-checkbox id="form-edit-favorite-input" type="checkbox" v-model="editRecipeForm.favorite" required>
            </b-form-checkbox>
          </b-form-group>
